...
- ✅ **Transacties toevoegen**: Voeg nieuwe bankrekening transacties toe via een intuïtief webformulier
...
- ✅ **Saldo berekening**: Automatische berekening van het totale banksaldo
